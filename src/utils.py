...
def seq_type_is_match_seq(seq_type, seq):
    ...
    if is_gene and seq_type in ["gene", "rna", "prot"]:
        return True
...
def download_trained_checkpoint_downstream_tasks(
        ...
        model_type=["lucapair2", "luca_base", "lucapair1", "luca_base", "lucapair2", "lucapair1", "luca_base", "luca_base", "luca_base", "luca_base"],
